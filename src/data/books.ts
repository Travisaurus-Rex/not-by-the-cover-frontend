export const books = [
  {
    ...
    tags: ["mystery", "magic", "introspective"],
    hook: "The sky never forgets what the earth tries to bury.",
    summary:
  ...
  },
  {
    ...
    hook: "The past was deleted. The city still remembers.",
    summary:
  ...
  {
    id: 3,
    title: "The Dream Between Us",
    author: "Lina Ortega",
    genre: "Romance / Drama",
    tags: ["romance", "surreal", "tragic"],
    hook: "Every night they meet, and every morning they forget.",
    summary:
  ...
  },
  {
    ...
    tags: ["science", "hubris", "survival"],
    hook: "Creation was never meant to be spectacle.",
    summary:
  ...
  },
  {
    ...
    author: "Stephen King",
    genre: "Horror / Drama",
    tags: ["supernatural", "coming of age", "fear"],
    hook: "Evil doesn’t die—it waits for you to grow up.",
    summary:
  ...
  },
  {
    ...
    tags: ["espionage", "tactical", "morality"],
    hook: "Precision can save lives—or erase them.",
    summary:
  ...
  {
    id: 7,
    title: "The Paper Alchemist",
    author: "Mira Tanaka",
    genre: "Fantasy / Mystery",
    tags: ["alchemy", "memory", "art"],
    hook: "Every creation demands a piece of its maker.",
    summary:
  ...
  {
    id: 8,
    title: "The Lighthouse Recordings",
    author: "Owen Pike",
    genre: "Mystery / Psychological",
    tags: ["haunting", "audio", "isolation"],
    hook: "Some voices echo long after the sea swallows them.",
    summary:
  ...
  },
  {
    ...
    author: "Rina D’Souza",
    genre: "Sci-Fi / Drama",
    tags: ["genetics", "ethics", "family"],
    hook: "Perfection was never meant to be inherited.",
    summary:
  ...
  {
    id: 10,
    title: "Beneath Glass Skies",
    author: "Khalid Monroe",
    genre: "Dystopian / Adventure",
    tags: ["rebellion", "AI", "freedom"],
    hook: "The city was built to protect them. It learned to imprison instead.",
    summary:
  ...
  },
  {
    ...
    tags: ["grief", "rebirth", "memory"],
    hook: "Love can bloom even in soil made of loss.",
    summary:
  ...
  },
  {
    ...
    tags: ["hacking", "identity", "consciousness"],
    hook: "Every system remembers its creator.",
    summary:
  ...
  },
  {
    ...
    tags: ["war", "family", "sacrifice"],
    hook: "Mercy is the hardest thing to carry through a storm.",
    summary:
  ...
  },
  {
    ...
    tags: ["music", "memory", "loss"],
    hook: "Some melodies take more than they give.",
    summary:
  ...
  {
    id: 15,
    title: "Firewatch Station 9",
    author: "Lydia Quinn",
    genre: "Thriller / Adventure",
    tags: ["wilderness", "mystery", "psychological"],
    hook: "The fire is gone. The voice on the radio isn’t.",
    summary:
  ...
  },
  {
    ...
    author: "Sophie Alaric",
    genre: "Drama / Sci-Fi",
    tags: ["time", "fate", "family"],
    hook: "Sometimes the hardest person to forgive is who you’ll become.",
    summary:
  ...
  {
    id: 17,
    title: "The Painted Prophet",
    author: "Ezekiel Moreau",
    genre: "Fantasy / Mystery",
    tags: ["prophecy", "betrayal", "destiny"],
    hook: "The future bleeds through every brushstroke.",
    summary:
  ...
  {
    id: 18,
    title: "Our Vanishing Hours",
    author: "Delilah Rhys",
    genre: "Romance / Psychological",
    tags: ["grief", "time", "dreams"],
    hook: "They were perfect together, except for the missing days.",
    summary:
  ...
  },
  {
    ...
    author: "Marcus Vail",
    genre: "Sci-Fi / Horror",
    tags: ["space", "signal", "unknown"],
    hook: "The message wasn’t meant to be heard by humans.",
    summary:
  ...
  },
  {
    ...
    tags: ["exploration", "maps", "philosophy"],
    hook: "Some discoveries only exist once you believe in them.",
    summary:
